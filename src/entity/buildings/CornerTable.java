...
public class CornerTable extends Building {
	...
	public void refreshImages() {
		...
		case 0:
			...
			break;
		case 1:
			animations[0][0][0] = gp.world.mapM.getRooms()[roomNum].getCounterSkin().getTableImage(96, 0, 32, 32);
			break;
		case 2:
			animations[0][0][0] = gp.world.mapM.getRooms()[roomNum].getCounterSkin().getTableImage(64, 32, 32, 32);
			break;
		case 3:
			animations[0][0][0] = gp.world.mapM.getRooms()[roomNum].getCounterSkin().getTableImage(96, 32, 32, 32);
			break;
		}	
	}
	public void destroy() {
