...
public class Room {
	...
	private void setBuildings() {
		...
		case 2:
			...
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3357, 4338, 167);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3555, 4341, 168);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3657, 4341, 169);
			arrayCounter++;
			...
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 3594, 4338, 8);
			arrayCounter++;
