...
public class Room {
	...
	private void setBuildings() {
		...
		case 0:
			...
			arrayCounter++;
			door = new Door(gp, 456, 182*3, 1, 0);
			door.setDoorNum(2);
			buildings[arrayCounter] = door;
			arrayCounter++;
			door = new Door(gp, 336, 132*3 + 32, 2, 0);
			door.setDoorNum(4);
			buildings[arrayCounter] = door;
			arrayCounter++;
			door = new Door(gp, 792, 420 + 32, 3, 0);
			door.setDoorNum(7);
			buildings[arrayCounter] = door;
			arrayCounter++;
			...
			buildings[arrayCounter] = new KitchenCounter(gp, 384, 384, 1);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 336, 336, 10);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 432, 384, 1);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 528, 384, 1);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 576, 384, 1);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 624, 384, 9);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 336, 288, 10);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 336, 240, 6);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 384, 240, 1);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 432, 240, 2);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 624, 336, 10);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 624, 288, 10);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 624, 240, 4);
			arrayCounter++;
			buildings[arrayCounter] = new KitchenCounter(gp, 336, 384, 8);
			arrayCounter++;
			buildings[arrayCounter] = new MenuSign(gp, 612+9, 363);
			arrayCounter++;
			buildings[arrayCounter] = new ChoppingBoard(gp, 564+9, 372);
			arrayCounter++;
			buildings[arrayCounter] = new Sink(gp, 327+9, 306);
			arrayCounter++;
			buildings[arrayCounter] = new Bin(gp, 369+9, 228, 0);
			arrayCounter++;
			buildings[arrayCounter] = new MenuBook(gp, 615+9, 318+9);
			arrayCounter++;
			buildings[arrayCounter] = new Stove(gp, 471+9, 234);
			arrayCounter++;
			buildings[arrayCounter] = new StorageFridge(gp, 570+9, 189, true);
			arrayCounter++;
			buildings[arrayCounter] = new Gate(gp, 480, 384, 0);
			arrayCounter++;
		...
		case 2:
			...
			buildings[arrayCounter] = door;
			arrayCounter++;
			door =  new Door(gp, 3978, 4809 + 32, 3, 6);
			door.setDoorNum(13);
			buildings[arrayCounter] = door;
			arrayCounter++;
			...
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 6852, 6207, 184);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 966, 1839, 203);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1047, 1839, 203);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 969, 1926, 203);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1050, 1926, 204);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 975, 1581, 186);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1029, 1581, 186);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1107, 1602, 187);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1164, 1602, 188);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 990, 1722, 190);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 651, 1701, 189);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1125, 1848, 185);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 600, 2073, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 711, 1587, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1116, 2040, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 624, 1782, 196);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 702, 1782, 196);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 726, 1797, 189);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 621, 1887, 197);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 702, 1887, 198);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 717, 1647, 199);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 765, 1635, 200);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 732, 2028, 193);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 777, 2028, 194);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 687, 2028, 193);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 777, 2145, 193);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 729, 2145, 194);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 684, 2166, 195);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 975, 2049, 191);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1053, 2049, 192);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 969, 2064, 186);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1065, 2088, 187);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1047, 1722, 206);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1047, 1722, 206);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1110, 1722, 187);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 975, 1542, 194);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1029, 1542, 193);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1296, 1644, 205);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 387, 2199, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1311, 2190, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1404, 1848, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 411, 1827, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1512, 1206, 8);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1803, 1245, 8);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1620, 1332, 8);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1875, 1470, 8);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1680, 1620, 8);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1851, 1704, 8);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1578, 1458, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1338, 1227, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1797, 1539, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1920, 1635, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1698, 1191, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1476, 1314, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1794, 1374, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1944, 1245, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1362, 1143, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1065, 1200, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1188, 1140, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1248, 1242, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 990, 1122, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 882, 1158, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 765, 1158, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1554, 2046, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1884, 2109, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1551, 2286, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1698, 2070, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1581, 2178, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1770, 2250, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1686, 2340, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1818, 2382, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1962, 2259, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1872, 2211, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1788, 1962, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 2037, 2097, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1659, 1926, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1956, 2385, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1611, 2454, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1815, 2460, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1974, 2469, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 2085, 2343, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1917, 1878, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1785, 1785, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1569, 1653, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1821, 1623, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1908, 1344, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1692, 1434, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1272, 1476, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1380, 1521, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1113, 1329, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 801, 1326, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 624, 1395, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 435, 1476, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 348, 1638, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 456, 1704, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 363, 1926, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 450, 2328, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 675, 2355, 7);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1119, 2346, 7);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 444, 2034, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1380, 1710, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 984, 1314, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 828, 1389, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 948, 1437, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 537, 1371, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 441, 1575, 205);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 624, 1563, 189);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1284, 1059, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1146, 1212, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1365, 1359, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1587, 1098, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1635, 1791, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1890, 1947, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1740, 2109, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1854, 2283, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1698, 2430, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 2034, 2511, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 2046, 2196, 0);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 1806, 2019, 0);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1494, 2109, 79);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2082, 2418, 80);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1707, 2169, 80);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1959, 2034, 78);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1761, 2334, 78);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1749, 1833, 78);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1920, 1689, 79);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1731, 1491, 80);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1422, 1179, 80);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1365, 1272, 79);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1209, 1353, 78);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1935, 1428, 78);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 1149, 2202, 78);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 615, 1602, 79);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 612, 2199, 80);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2409, 4917, 208);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2418, 4998, 150);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2550, 4998, 150);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2697, 4911, 146);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2625, 5007, 29);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2760, 4992, 39);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2688, 5007, 29);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2352, 4977, 175);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2661, 4761, 152);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2397, 4848, 18);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2598, 4851, 18);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2778, 4914, 30);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2778, 4956, 30);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2841, 4980, 212);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2844, 5019, 210);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2895, 5019, 210);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2982, 4974, 157);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3009, 4986, 32);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2970, 4989, 173);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3216, 5061, 8);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 3201, 4986, 7);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 2919, 4932, 7);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2832, 4932, 209);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3111, 4977, 15);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 3036, 4920, 9);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 2979, 4920, 9);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3183, 5382, 213);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3207, 5388, 171);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3207, 5388, 171);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 3303, 5442, 9);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3366, 5496, 38);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3396, 5394, 174);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3156, 5490, 150);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3318, 5505, 31);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3270, 5505, 29);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3219, 5418, 15);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3351, 5337, 44);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3813, 5211, 73);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3879, 5373, 53);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3810, 5349, 52);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3300, 4941, 211);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4263, 5262, 30);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4557, 5259, 15);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4581, 5340, 29);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4536, 5334, 30);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4446, 5337, 8);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4653, 5337, 8);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4347, 5136, 171);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 4377, 5184, 8);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 4419, 5184, 8);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 4419, 5184, 8);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4323, 5340, 40);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4404, 5340, 40);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4731, 5337, 173);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4776, 5340, 55);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 4767, 5262, 3);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 4686, 5265, 3);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4311, 5244, 182);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4311, 5244, 182);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 4563, 5178, 9);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 4650, 5172, 9);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 4809, 5172, 9);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4620, 5166, 20);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4848, 5172, 20);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 4728, 5151, 1);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5286, 5205, 6);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4962, 5190, 4);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5181, 5283, 174);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5241, 5313, 30);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5184, 5316, 29);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5241, 5289, 32);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4851, 5274, 31);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4848, 5316, 29);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4851, 5232, 30);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4851, 5232, 30);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5430, 5112, 19);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5283, 5112, 19);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 5049, 5139, 2);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 5349, 5079, 3);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 5352, 5181, 9);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 5004, 5268, 4);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 5088, 5268, 4);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5148, 5337, 38);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5274, 5340, 38);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorWindow(gp, 5346, 5268, 5);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5346, 5343, 150);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 4986, 5343, 150);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 5082, 5352, 29);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3666, 4914, 156);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3594, 4875, 150);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2556, 5901, 178);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2289, 5904, 178);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 3090, 6030, 29);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2715, 6027, 30);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 3735, 6633, 11);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 3684, 6315, 12);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 2469, 6651, 11);
			arrayCounter++;
			buildings[arrayCounter] = new SeasonalDecoration(gp, 2361, 6222, 12);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2808, 6417, 30);
			arrayCounter++;
			buildings[arrayCounter] = new OutdoorDecor(gp, 2856, 6414, 31);
			arrayCounter++;
			...
			break;
		case 3:
			door = new Door(gp, 432, 204+48 + 32, 2, 0);
			door.setDoorNum(8);
			buildings[arrayCounter] = door;
			arrayCounter++;
			...
			break;
		case 4:
			door = new Door(gp, 720+24, 264+16+48 + 32, 3, 0);
			door.setDoorNum(0);
			buildings[arrayCounter] = door;
			arrayCounter++;
		...
		case 7: // Abandoned corridor
			...
			door = new Door(gp, 240, 384 + 32, 2, 0);
			door.setDoorNum(0);
			buildings[arrayCounter] = door;
			arrayCounter++;
		...
		case 8: //Corridor 1
			...
			buildings[arrayCounter] = door;
			arrayCounter++;
			door = new Door(gp, 648, 372 + 32, 3, 0);
			door.setDoorNum(3);
			buildings[arrayCounter] = door;
			arrayCounter++;
