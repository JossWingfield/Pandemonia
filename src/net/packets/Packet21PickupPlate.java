...
public class Packet21PickupPlate extends Packet {
    ...
    public Packet21PickupPlate(String username, Plate plate, int arrayIndex) {
        super(21);
    ...
    public Packet21PickupPlate(byte[] data) {
        super(21);
    ...
    public byte[] getData() {
        ...
        return ("21" + isDirty + "," + ingredientsString + "," + username + "," + arrayIndex).getBytes();
    }
