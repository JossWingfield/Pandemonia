...
public class Debug {
	...
	public void draw(Graphics2D g2) {
		 if (debugBloom) {
	            ...
	            g2.fillRect(0, screenHeight - overlayHeight, screenWidth, overlayHeight);
	            ...
	            g2.drawString(title, (screenWidth - titleWidth) / 2, screenHeight - overlayHeight + 22);
	            g2.drawString(info,  (screenWidth - infoWidth)  / 2, screenHeight - 15);
	        }
	}
