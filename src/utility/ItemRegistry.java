...
public class ItemRegistry {
	...
	public Item getItemFromName(String name, int state) {
		...
		switch(name) {
			...
			case "Chamomile" -> i = new Chamomile(gp, 0, 0);
			case "Mint" -> i = new Mint(gp, 0, 0);
			case "Paprika" -> i = new Paprika(gp, 0, 0);
			case "Turmeric" -> i = new Turmeric(gp, 0, 0);
			case "Cumin" -> i = new Cumin(gp, 0, 0);
			case "Chilli Flakes" -> i = new ChilliFlakes(gp, 0, 0);
			case "Star Anise" -> i = new StarAnise(gp, 0, 0);
